...
class EDD_SL_Theme_Updater {
	...
	function update_nag() {
		...
		$api_response = false;//get_transient( $this->response_key );
		...
		if ( version_compare( $this->version, $api_response->new_version, '<' ) ) {
			...
			echo '<div id="update-nag">';
				printf( '<strong>%1$s %2$s</strong> esta disponible. <a href="%3$s" class="thickbox" title="%4s">Ver registro de cambios</a> o <a href="%5$s"%6$s>Actualizar</a>.',
					$theme->get( 'Name' ),
