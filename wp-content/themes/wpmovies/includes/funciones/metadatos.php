...
************************************************************************************************************************************/
'poster_url' => array( 'name' => 'poster_url', 'title' => __('URL Poster (optional)', 'mundothemes'), 'type' => 'text', 'desc' => __('', 'mundothemes')),
'cover_url' => array( 'name' => 'cover_url', 'title' => __('Cover image URL (optional)', 'mundothemes'), 'type' => 'text', 'desc' => __('', 'mundothemes')),
'Title' => array( 'name' => 'Title', 'title' => __('Original title', 'mundothemes'), 'type' => 'text', 'desc' => __('', 'mundothemes')),
'Rated' => array( 'name' => 'Rated', 'title' => __('Rated', 'mundothemes'), 'type' => 'text', 'desc' => __('', 'mundothemes')),
'Released' => array( 'name' => 'Released', 'title' => __('Release Date', 'mundothemes'), 'type' => 'text', 'desc' => __('', 'mundothemes')),
'Language' => array( 'name' => 'Language', 'title' => __('Language', 'mundothemes'), 'type' => 'text', 'desc' => __('', 'mundothemes')),
'Runtime' => array( 'name' => 'Runtime', 'title' => __('Runtime', 'mundothemes'), 'type' => 'text', 'desc' => __('', 'mundothemes')),
'imdbRating' => array( 'name' => 'imdbRating', 'title' => __('IMDB Rating', 'mundothemes'), 'type' => 'text', 'desc' => __('', 'mundothemes')),
'imdbVotes' => array( 'name' => 'imdbVotes', 'title' => __('IMDB votes', 'mundothemes'), 'type' => 'text', 'desc' => __('', 'mundothemes')),
'Awards' => array( 'name' => 'Awards', 'title' => __('Awards', 'mundothemes'), 'type' => 'text', 'desc' => __('', 'mundothemes')),
'Country' => array( 'name' => 'Country', 'title' => __('Country', 'mundothemes'), 'type' => 'text', 'desc' => __('', 'mundothemes')),	
);
}
...
elseif ( $meta['type'] == 'mundothemesselect' )
get_meta_mundothemesselect( $meta, $value );
...
function get_meta_mundothemesselect( $args = array(), $value = false ) { extract( $args ); ?>
<tr>
<th style="width:20%;">
