...
class XooPaypalPayment 
{
	...
	public function package_edit_form()
	{
		...
		if (!empty($package)){				
		 ...
		 $html .='<input type="hidden" id="uultra_wp_nonce" value="'.$ajax_nonce.'"  />';
	...
	public function package_edit_confirm ()
	{
		...
		check_ajax_referer( 'uultra-nonce-check-db-az-346', 'security' );
			
		$package_name   = sanitize_text_field($_POST['p_name']);					
		$package_desc   =  sanitize_text_field($_POST['p_desc']);
	...
	public function package_add_new ()
	{
		...
		$new_message = array(
						...
						'package_name'   => sanitize_text_field($_POST['p_name']),						
						'package_desc'   =>  sanitize_text_field($_POST['p_desc']),
						'package_type'   =>  sanitize_text_field($_POST['p_type']),
						'package_number_of_times'   =>  sanitize_text_field($_POST['p_every']),
						'package_time_period'   =>  sanitize_text_field($_POST['p_period']),
						'package_amount'   =>  sanitize_text_field($_POST['p_price']),
						
						'package_approvation'   =>  sanitize_text_field($_POST['p_moderation']),
						'package_limit_photos'   =>  sanitize_text_field($_POST['p_max_photos']),
						'package_limit_galleries'   =>  sanitize_text_field($_POST['p_max_gallery']),
