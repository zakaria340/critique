...
Users Ultra is the ideal plugin for creating advanced user communities & networks easily. It includes Social Login & Paid Membership Features
...
<p><strong>Even More Great Features</strong>:</p>
<ul>
<li>Photos &amp; Galleries</li>
<li>Drag &amp; Drop Multi-Uploader</li>
<li>Promotion Options</li>
<li>5 Stars Rating System</li>
<li>Detailed Stats</li>
<li>Top Rated Features:</li>
<li>Most Visited:</li>
<li>Youtube &amp; Vimeo Videos</li>
<li>User&rsquo;s Avatar:</li>
</ul>
...
<ul>
  ...
  <li>Hebrew. Thanks to <a href=' https://profiles.wordpress.org/ahrale/'>Ahrale</a></li>  
    <li>Hungarian. Thanks to István.</li> 
	 <li>Rusian. Thanks to <a href=' https://wordpress.org/support/profile/bob_2222'>bob_2222</a></li> 
 
</ul>

<h3>Special Thanks to:</h3>
James H. Twitter account @g0blinResearch
<a href='https://profiles.wordpress.org/panvagenas/'> Panagiotis Vagenas </a>
...
Yes, https://usersultra.com/doc.html

= Do you offer free support? =

Yes, https://www.usersultra.com/support/

= Do you offer a PRO version? =

Yes, https://usersultra.com/users-pro.html
...
= 1.5.70(01-04-2016) =
* Improvement - WP 4.4 Improvementes.
* Improvement - Localization issue with JS files and warning messages.


= 1.5.69(12-27-2015) =
* Improvement - Date Picker Style issue with some premium themes.
* Improvement - Tweak on coding in order to avoid possible XSS attack. Although, the plugin is safe we recommend you updating it, just to avoid any security issues.


= 1.5.68(12-21-2015) =
* Improvement - Language files updated.
* Improvement - WP version 4.4 tweaks.
* Improvement - jQuery improvements in order to avoid any JS conflict with premium themes.

= 1.5.67(12-16-2015) =
* Improvement - WooCommerce conflict with checkbox and radio buttons.

= 1.5.66(12-16-2015) =
* Improvement - We have tweaked the rating system in order to make it much more safe. Please update.
* Improvement - Social features were improved in order to adapt them to the new Facebook API.
* Improvement - WooCommerce class improved.
 
= 1.5.65(12-11-2015) =
* Improvement - Improvements on the user rating system. Please update.
* Improvement - Photos, Galleries and Videos module improvements. Please update.

= 1.5.64(12-09-2015) =
* Improvement - We have improved the SQL sentences in order to avoid any kind of vulnerability. Please update.

= 1.5.63(12-06-2015) =
* Improvement - Major Update. Please move your folder to your upload folders. We have implemented a major improvement on the way UU handles the upload files. You will see intructions right after you have updated the plugin.
* Improvement - We have removed temporally LightBox. Lightbox 2 is CC 2.5 which is not GPL compatible.
* Bug Fix - We have added nonce to the Membership Module in order to avoid Vulnerability .
* Bug Fix - We have sanitzed some fields on the Front End publisher and Packages Module.


= 1.5.62(11-30-2015) =
* Improvement - Coding Improvement.
* Improvement - PayPal IPN tweaks to work well with SSL.
* Improvement - CSS styles has been improved. Now, the css stylesheet should load faster.

= 1.5.61(11-23-2015) =
* Improvement - Email re-type setting tweaks.
* Bug Fix - Warning message displayed on screen. Check details here https://wordpress.org/support/topic/error-every-where-undefined-variable?replies=3


= 1.5.60(11-22-2015) =
* Improvement - Warning message displayed when editing users profile.
* Improvement - Language Update.

= 1.5.59(11-15-2015) =
* New Feature - Do not force users to retype their email. Details on this topic https://wordpress.org/support/topic/do-not-force-users-to-retype-their-email?replies=4.
* Improvement - Security Issues when Importing users with CSV file has been fixed.

= 1.5.58(11-05-2015) =
* Bug Fix - Issue fixed on Messaging class. UTF-81 should be UTF-8.
...
* Improvements - Css clash issue on a permium theme. We've tweaked the css a little bit.
* Improvements - Twitter Sign up tweak. The Twitter API has updated.

= 1.5.54(10-14-2015) =
* Improvements - We received some reports of some people having issues with the Instagram Login feature on the lite version. We've tweaked the code and everything should be working the way it should now.

= 1.5.53(10-13-2015) =
* Bug Fix - Facebook CURL library, error message. Details of this issue can be found here https://usersultra.com/support/forums/topic/problem-with-login-2/

= 1.5.52(10-08-2015) =
* Bug Fix - We have removed some warning messages caused when using the plugin on some premium themes. This is a minor tweak, please update if you need it and if you're seeing the warning messages in your front pages.


= 1.5.51(10-07-2015) =
* New Feature - A new option has been added to the profile is not visible if the payment wasn't received. Also, there is an option to display a custom message.
* Improvement - Registration link missed. Details here https://usersultra.com/support/forums/topic/login-widget-lost-its-register-link/
...
= 1.5.49(09-29-2015) =
* Improvement - Facebook API Updates.
* Improvement - Coding clean up.
* Improvement - YouTube videos now work with ID and entire URL on public profile.
* Improvement - Language mo and po files were updated.
* New Feature - Option to remove register link on the login form.
* New Feature - Option to set a custom registration URL. Details here https://wordpress.org/support/topic/shortcodes-for-pro-version-only?replies=3#post-7481394


= 1.5.48(09-25-2015) =
* Improvement - New option added to the "uultra_search_form" shortcode. Now you can set your own target page by using the "target_page_url" URL. This can be used when using the search box on the sidebar. 


= 1.5.47(09-22-2015) =
* Improvement - Please update, we had to change the "period" option to "period_label" for the pricing table shortcode.
* Improvement - More tweaks in order to prevent any issue with PayPal IPN.
* Improvement - Main Stylesheet has been reduced in order to make the plugin load faster.

= 1.5.46(09-17-2015) =
* Improvement - Option to remove the "period" on pricing tables. Check details here https://usersultra.com/support/?topic=problem-with-sale-button. Check the updated features for the <a href='http://doc.usersultra.com/pricing-tables/'>Users Ultra Pricing Tables Shortcode</a>

= 1.5.45(09-14-2015) =
* Improvement - Paypal 2015-2016 SSL Certificate Change Microsite. Please update your plugin ASAP. Please read this link, some of the changes Paypal is doing are related to your server as well. https://www.paypal-knowledge.com/infocenter/index?page=content&id=FAQ1766&expand=true&locale=en_US
...
* Improvement - Facebook API Update. Check details here here: <a href='http://usersultra.com/support/forums/topic/submit-for-login-review-required-by-facebook/'>Users Ultra Forums</a> 
